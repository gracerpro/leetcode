...
class Solution {
    ...
    function robotSim($commands, $obstacles) {
        ...
        foreach ($obstacles as $obstacle) {
            $obstacleMap[$obstacle[0] . '_' . $obstacle[1]] = true;
        }

        foreach ($commands as $command) {
            if ($command === -2) {
                // turn left
                $rotationVector = $rotationVector + 90 >= 360 ? 0 : $rotationVector + 90;
            }
            else if ($command === -1) {
                // turn right
                $rotationVector = $rotationVector - 90 < 0 ? 270 : $rotationVector - 90;
            }
                ...
                for ($i = 0; $i < $command; ++$i) {
                    ...
                    // if find the obstacle
                    if (isset($obstacleMap[$tmpX . '_' . $tmpY])) {
                        break;
                    }
                    ...
                    $tmpDistance = $currentX * $currentX + $currentY * $currentY;
...
echo "Count commands ", count($commands), "\n";
echo "Count obstacles ", count($obstacles), "\n";
